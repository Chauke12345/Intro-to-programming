...
function replaceIt() {
    ...
    let theStory = "<h1>Monday News</h1> ";
    theStory += 'it was ' + adj1 + ' monday, ';
    theStory += 'Douglas was ' + verbING;
    theStory += ' in his bed ' + roomInHouse;
    theStory += ', trying to sleep ' + color + ' ' + nounPlural + '.<br></br>';
    theStory += ' As he is about  ' + pastVerb + ' to ' + beverage + ', ';
    theStory += 'he heard ' + musicType + ' music ';
    theStory += 'playing in the ' + diffRoom + '.<br></br> ';
    theStory += exclamation + '! yoooo, ';
    theStory += 'as he walked ' + pastVerb2 + ' down the stairs to join the ';
